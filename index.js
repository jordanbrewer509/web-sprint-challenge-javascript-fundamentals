...
// Since the function nestedFunction() is called outside of the function with the statement on line 14, the variable 'internal' can be used outside of the function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals) {
    const lowercaseAnimals = zooAnimals.map((element) => {
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals) {
    const filterAnimals = zooAnimals.filter((element) => {
  ...
  */
  ...
  function USApop(zooAnimals) {
    const totalPopulation = zooAnimals.reduce((accumulator, currentValue) => {
...
class CuboidMakerTwo extends CuboidMaker{
  constructor(object) {
    ...
    this.surfaceArea = super.surfaceArea;
  }
}
